...
-- Started on 2024-01-15 07:43:44 UTC
...
13	test@gmail.com	$2y$10$LFVUD6hybS6OiLSOiiC15us1nUti0kcbLSRJj0mGLfS6EndjzwKaq	111-111-111	test
...
COPY public."Transaction" ("idTransaction", "idUser", "idAdmin", weight_with_boxes, "idBox", "numberOfBoxes", "idPrice", "transactionDate", weight, amount) FROM stdin;
94	27	16	4.5	27	1	38	2024-01-09	3.3	16.5
97	26	16	23.4	27	2	41	2024-01-09	21	48.3
99	27	16	56.5	27	3	38	2024-01-10	52.9	264.5
105	27	16	45.6	27	4	41	2024-01-11	40.8	93.84
110	26	16	12.4	27	2	38	2024-01-11	10	50
111	26	16	24.5	27	5	38	2024-01-11	18.5	92.5
119	26	16	34.5	27	3	38	2024-01-11	30.9	154.5
\.
...
26	Przemysław	Mazur	pmazur@gmail.com	$2y$10$zWEEzRKZ398pB7Oyjq/Pj.0XDh4i2DLS42r0U02mjkkzXnntGCpbS	16
...
SELECT pg_catalog.setval('public."Admin_idAdmin_seq"', 16, true);
...
SELECT pg_catalog.setval('public."Box_idBox_seq"', 29, true);
...
SELECT pg_catalog.setval('public."FruitPrices_idPrice_seq"', 41, true);
...
SELECT pg_catalog.setval('public."Fruit_idFruit_seq"', 45, true);
...
SELECT pg_catalog.setval('public."Transaction_idTransaction_seq"', 119, true);
...
SELECT pg_catalog.setval('public."User_idUser_seq"', 27, true);
...
-- Completed on 2024-01-15 07:43:44 UTC
