...
<head>
    ...
    <title>Frusion - status frusion</title>
    ...
    <link rel="stylesheet" href="/public/css/status_frusion.css">
    ...
    <div class="kontener">
        ...
        <div class="pasek_boczny" id="mySidebar">
            ...
            <ul class="menu">
                ...
                <li id="status_frusion" class="active"><a href="status_frusion">Status Frusion</a></li>
