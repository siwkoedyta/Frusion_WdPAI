...
<body class="login">
    ...
    <div class="login-container">
        ...
        <div class="logo_z_napisem">
            <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="81" height="77" viewBox="0 0 81 77" fill="none">
        ...
        <form>
            ...
            <div class="Sign_in_z_strzalka">
              ...
              <button class="strzalka" id="przycisk_redirect">
                  <svg xmlns="http://www.w3.org/2000/svg" width="71" height="43" viewBox="0 0 71 43" fill="none">
                      ...
                      <defs>
                        <linearGradient id="paint0_linear_10_1362" x1="0" y1="0" x2="38.1071" y2="62.921" gradientUnits="userSpaceOnUse">
            ...
            <div id="dont_z_create">
                <h4 id="dont">Don’t have an account? </h4>
                <button class="create-button"><a href="panel_rejerstracji">Create</a></button>
            </div>
        </form>
    </div>
